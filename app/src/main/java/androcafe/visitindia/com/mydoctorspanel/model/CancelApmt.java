...
public class CancelApmt {
    ...
    public CancelApmt(int id, int pid, String patient_img, String patient_name, int patient_age, String apmt_date, String age, String treatment, String time, String sex, int docid) {
        this.id = id;
        this.pid = pid;
